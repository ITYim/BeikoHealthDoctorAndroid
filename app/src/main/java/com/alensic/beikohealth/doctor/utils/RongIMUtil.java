package com.alensic.beikohealth.doctor.utils;

import android.content.Context;
import android.net.Uri;

import com.alensic.beikohealth.doctor.base.GlobalParams;
import com.alensic.beikohealth.doctor.bean.ImageOnlyExtensionModule;
import com.alensic.beikohealth.doctor.http.HttpManager;
...
public class RongIMUtil {
    ...
    public static Subscriber connectRongIM(String userId, String userName, String portraitUri) {
        ...
        String appKey = GlobalParams.getContext().getString(io.rong.imlib.R.string.RONG_DOCTOR_CLOUD_APP_KEY);
        String appSecret = GlobalParams.getContext().getString(io.rong.imlib.R.string.RONG_DOCTOR_CLOUD_APP_SECRET);
